...
var knownPropertyDescriptions = map[string]string{
	...
	"name":                   "Name.",
	"name_pattern":           "Case-insensitive substring to match in tool names or descriptions.",
	"only_services":          "Limit a job-mode run to these service names.",
	"except_services":        "Exclude these service names from a job-mode run.",
